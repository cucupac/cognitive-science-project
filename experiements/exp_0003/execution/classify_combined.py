...
For each dropout level (25, 50, 75, 90):
  ...
  3) Appends results to: experiements/exp_0003/results/data/combined/multi_dropout_results.csv
...
os.makedirs("experiements/exp_0003/results/data/combined", exist_ok=True)

CSV_RESULTS_PATH = (
    "experiements/exp_0003/results/data/combined/multi_dropout_results.csv"
)
