...
3) Overwrites the CSV in experiements/exp_0002/results/data/combined/results.csv
...
os.makedirs("experiements/exp_0002/results/data/combined", exist_ok=True)

CSV_RESULTS_PATH = "experiements/exp_0002/results/data/combined/results.csv"
