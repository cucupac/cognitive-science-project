...
Analyzes combined modality results from:
  experiements/exp_0001/results/data/combined/results.csv
...
COMBINED_RESULTS_CSV = "experiements/exp_0001/results/data/combined/results.csv"
OUTPUT_PLOT = "experiements/exp_0001/results/images/combined/accuracy_vs_alpha.png"
OUTPUT_BEST_CSV = "experiements/exp_0001/results/data/combined/best_alpha_summary.csv"
...
def main():
    ...
    # 3. Identify best alpha for each representation
    best_rows = []
    print("\n=== Best Alpha for Each Combined Representation ===")
    for rep in representations:
    ...
    print(
        "\nNote: alpha=0.0 or alpha=1.0 effectively represent single-modality baselines "
        "for each representation, so this plot and summary inherently compare baselines "
        "with mid-range alpha values."
    )
